...
export async function getServerSideProps(ctx: GetServerSidePropsContext) {
    ...
    const movie = await fetch("https://api.themoviedb.org/3/trending/person/week?api_key=" + process.env.APIKEY?.toString() + "&language=en-US&include_adult=false").then((response) => response.json());
    const type = "person";
