    ...
    return (
        <>
            <div className={"relative flex flex-col p-2 break-words shadow-soft-xl rounded-2xl bg-clip-border min-w-full" + height}>
                <div className="relative h-32 w-full overflow-hidden bg-cover rounded-xl bg-no-repeat bg-center hover:scale-105 transition" style={{backgroundImage: "url(" + itemdata.image + ")"}} 
                    ...
                    {movie_loading == itemdata.itemname.toString() ?
                        <>
                            <div role="status" className="block z-10 m-auto pt-10">
